...
#empty placeholder for messages
#messages_placeholder = sl.empty()
...
if sl.button("Send"):
    ...
    response = generate_text_with_temperature(user_input, next_words=110, temperature=1)
     #Add user input and model's response to conversation history
    sl.session_state['conversation_history'].append(("You: " + user_input, "Model: " + response))
